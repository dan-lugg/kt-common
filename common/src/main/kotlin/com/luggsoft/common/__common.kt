...
internal fun main()
{
    ...
    writer.appendLine("package com.luggsoft.common")
    writer.appendLine("import java.util.concurrent.ConcurrentHashMap")
    writer.appendLine("import java.util.concurrent.ConcurrentMap")
